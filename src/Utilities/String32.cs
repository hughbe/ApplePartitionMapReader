...
public struct String32 : ISpanFormattable
{
    ...
    /// <summary>
    /// Creates a <see cref="String32"/> from an ASCII string.
    /// </summary>
    /// <param name="value">The string value to convert. Must be at most 32 characters.</param>
    /// <returns>A new <see cref="String32"/> containing the ASCII representation of the string.</returns>
    /// <exception cref="ArgumentException">Thrown when the string is longer than 32 characters.</exception>
    public static String32 FromString(ReadOnlySpan<char> value)
    {

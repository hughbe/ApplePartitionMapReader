...
internal static class SpanUtilities
{
    ...
    /// <summary>
    /// Reads a null-terminated ASCII string (C-style) from the specified span.
    /// </summary>
    /// <param name="data">The span containing the string bytes.</param>
    /// <returns>The decoded string up to the first null terminator or span end.</returns>
    public static string ReadCString(ReadOnlySpan<byte> data)
    {
